...
Note that if you plan to support tweets with polls, your app has to be approved for Twitter's Ads API. See [the Ads API Application Form](https://github.com/gr2m/twitter-together/blob/master/docs/03-apply-for-access-to-the-twitter-ads-api.md) documentation for more details.
